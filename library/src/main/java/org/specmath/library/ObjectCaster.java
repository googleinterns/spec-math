...
public class ObjectCaster {
   ...
   * the YAML file within the library (in the org.specmath.library.YamlStringToSpecTreeConverter class), it becomes a
   * LinkedHashMap<String, Object> which is a Map<String, Object>. The value of map could be another
   * Map, or other stuff i.e. List, String, Integer, Boolean. This piece of the code assumes that
   * the provided Map fits this criteria, namely that if the value is a Map, then it will always be
   * a Map<String, Object>. Usage of this function is internal in the library where we can guarantee
   * that the map parameter provided is Map<String, Object> where if the Object value is a Map, and
   * it passes the (value instanceof Map) condition, then it must be some Map<String, Object>.
   *
